...
\todo[description installation + images]
...
Afin de faciliter le développement modulaire, les bibliothèques de \emph{Contiki} incluent un mécanisme de processus légers à ordonnancement coopératif \citeweb{protothreads}.
